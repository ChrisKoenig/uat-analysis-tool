...
#   az acr build -r acrgcsdevgg4a6y -f containers/triage-ui.Dockerfile -t gcs/triage-ui:latest .
# =============================================================================
...
COPY triage-ui/package.json triage-ui/package-lock.json ./
...
COPY containers/nginx-triage.conf.template /etc/nginx/templates/default.conf.template
