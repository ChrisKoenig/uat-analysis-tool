...
def get_analyzer():
    ...
    if _analyzer is None:
        ...
        if workspace_root not in sys.path:
            ...
            sys.path.insert(0, os.path.join(workspace_root, 'apps'))
...
def _map_hybrid_to_analysis_result(
    ...
    try:
        ...
        if _proj_root not in sys.path:
            ...
            sys.path.insert(0, os.path.join(_proj_root, 'apps'))
        from shared.servicetree_service import get_servicetree_service
...
def get_graph_user(email: str):
    ...
    """
    import re as _re
    from shared.graph_user_lookup import get_user_info
...
async def get_diagnostics():
    ...
    try:
        from shared.config import get_app_config, APP_ENV
        _cfg = get_app_config()
        _env_info = {
            "name": APP_ENV,
