...
from shared.intelligent_context_analyzer import IssueCategory, IntentType
...
class EnhancedMatchingConfig:
    ...
    try:
        from shared.config import get_app_config as _gcfg2
    ...
    def get_uat_credential():
        ...
        try:
            from shared.ado_integration import AzureDevOpsConfig
